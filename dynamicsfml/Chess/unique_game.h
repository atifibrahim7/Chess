...
bool final_check;
    ...
    std::unique_ptr<Pieces> w_rook[2];
    std::unique_ptr<Pieces> b_rook[2];
    std::unique_ptr<Pieces> w_king;
    std::unique_ptr<Pieces> b_king;
    std::unique_ptr<Pieces> w_queen;
    std::unique_ptr<Pieces> b_queen;
    std::unique_ptr<Pieces> w_bishop[2];
    std::unique_ptr<Pieces> b_bishop[2];
    std::unique_ptr<Pieces> w_knight[2];
    std::unique_ptr<Pieces> b_knight[2];
    std::unique_ptr<Pieces> w_pawn[8];
    std::unique_ptr<Pieces> b_pawn[8];
    std::unique_ptr<Pieces> white_piece[16];
    std::unique_ptr<Pieces> black_piece[16];
...
Game()
{
    ...
    final_check = 1;
        ...
        m = std::make_unique<Menu>();

        w_king = std::make_unique<W_King>("images/Peices/King W.png");
        b_king = std::make_unique<B_King>("images/Peices/King B.png");

        w_queen = std::make_unique<W_Queen>("images/Peices/Queen W.png");
        b_queen = std::make_unique<B_Queen>("images/Peices/Queen B.png");

        for (int i = 0; i < 2; i++)
        {
            w_rook[i] = std::make_unique<W_Rook>("images/Peices/Rook W.png");
            b_rook[i] = std::make_unique<B_Rook>("images/Peices/Rook B.png");

            w_bishop[i] = std::make_unique<W_Bishop>("images/Peices/Bishop W.png");
            b_bishop[i] = std::make_unique<B_Bishop>("images/Peices/Bishop B.png");

            w_knight[i] = std::make_unique<W_Knight>("images/Peices/Knight W.png");
            b_knight[i] = std::make_unique<B_Knight>("images/Peices/Knight B.png");
        }

        for (int i = 0; i < 8; i++)
        {
            w_pawn[i] = std::make_unique<W_Pawn>("images/Peices/Pawn W.png");
            b_pawn[i] = std::make_unique<B_Pawn>("images/Peices/Pawn B.png");
...
void check_upgrade_white(Event& e)
{
    ...
    float temp_select = selected_piece;
        ...
        if (white_piece[selected_piece]->sprite.getPosition().y == coord_y[0] && !white_piece[selected_piece]->upgrade_flag)
        {
            ...
            std::unique_ptr<Pieces> temp_piece;
            // if (e.key.code == sf::Keyboard::Num1)
            temp_piece = std::make_unique<W_Queen>("images/Peices/Queen W.png");
...
void check_upgrade_black(Event& e)
{
    ...
    float temp_select = selected_piece;
        ...
        if (black_piece[selected_piece]->sprite.getPosition().y == coord_y[7] && !black_piece[selected_piece]->upgrade_flag)
        {
            ...
            unique_ptr<Pieces> temp_piece;
            // if (e.key.code == sf::Keyboard::Num1)
                temp_piece = make_unique<B_Queen>("images/Peices/Queen B.png");
            ...
            black_piece[selected_piece] = move(temp_piece);
